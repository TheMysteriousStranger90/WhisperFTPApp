...
public interface IFtpService
{
    ...
    Task CreateDirectoryAsync(FtpConfiguration configuration, string remotePath, CancellationToken cancellationToken = default);
    Task DeleteDirectoryAsync(FtpConfiguration configuration, string path, CancellationToken cancellationToken = default);
    Task<bool> DirectoryExistsAsync(FtpConfiguration configuration, string remotePath, CancellationToken cancellationToken = default);
    Task<string> GetWorkingDirectoryAsync(FtpConfiguration configuration, CancellationToken cancellationToken = default);
    ...
    Task UploadFileWithResumeAsync(FtpConfiguration configuration, string localPath, string remotePath, IProgress<double>? progress = null, CancellationToken cancellationToken = default);
    ...
    // ===== File Operations (Management & Info) =====
    Task RenameAsync(FtpConfiguration configuration, string currentName, string newName, CancellationToken cancellationToken = default);
    ...
    Task<FileSystemItem> GetFileDetailsAsync(FtpConfiguration configuration, string remotePath, CancellationToken cancellationToken = default);
